...
- [x] `docs/lecons/next.js/auth_courriel.md` — verifie humain (revalide le 2026-07-20, reecrit par l'utilisateur)
- [x] `docs/lecons/next.js/auth_oauth.md` — verifie humain (revalide le 2026-07-20, reecrit par l'utilisateur)
- [x] `docs/lecons/next.js/auth_protection.md` — verifie humain (revalide le 2026-07-20, reecrit par l'utilisateur)
