...
<figure markdown>
  ![exercice](images/nextjs-composantes.png){ width="600" }
  <figcaption>Aspect visuel de l'exercice de composantes dans Next.js</figcaption>
</figure>


[Version démo](https://next-server-client.profinfo.ca)  